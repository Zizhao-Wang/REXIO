...
billion=1000000000
range_dividers=(1)
ratio_dividers=(10 20 30 40 50 60 70 80 90)
...
for i in {1..1}; do
    ...
    for divider in ${range_dividers[@]}; do
        for rw_ratio in ${ratio_dividers[@]}; do
            ...
            for value_size in  512 ; do
                ...
                log_file="NEXIO_${num_format}_ratio_${rw_ratio}_val_${value_size}.log"
                cd $dir3
                if [ -f "$log_file" ]; then
